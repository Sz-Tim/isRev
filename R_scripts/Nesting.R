...
# This script explores elevational patterns of ant nesting habits. In
# particular, ground vs arboreal ants with those habits generalized at the
# genus level due to data availability and time constraints.
...
ggplot(traits.df, aes(x=factor(Elsamp), fill=NestingSite)) + geom_bar(position="fill") + facet_wrap(~Transects)
